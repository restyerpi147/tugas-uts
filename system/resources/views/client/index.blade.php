   ...
   <body class="main-layout">
                  ...
                  <div id="slider_main" class="carousel slide" data-ride="carousel">
                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <img src="{{url('public')}}/assets/images/slider_1.png" alt="#" />
                        </div>
               ...
               @foreach($list_blog as $blog)
                <div class="card mb-3">
                    <div class="card-body">
                      ...
                      <p class="card-text">Penulis : {{$blog->penulis}} | Tanggal : {{$blog->created_at}}</p>
      ...
      <div class="section layout_padding dark_bg">
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-6">
                  <img src="{{url('public')}}/assets/images/marketing_img.png" alt="#" />
               </div>
               <div class="col-md-6">
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-6">
                  <a href="#"><img src="{{url('public')}}/assets/images/footer_logo.png" alt="#" /></a>
